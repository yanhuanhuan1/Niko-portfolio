      ...
      <div className="mx-auto w-full max-w-275 px-6 py-20 sm:px-10 sm:py-32 lg:py-36">
        <FadeIn className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <SplitText
            ...
            className="mt-4 whitespace-nowrap font-serif text-[1.75rem] font-medium leading-[1.05] tracking-normal text-foreground sm:mt-5 sm:whitespace-normal sm:text-[2.75rem] md:text-[3.35rem] lg:text-[3.95rem]"
            delay={30}
            duration={0.72}
            splitType={splitType}
            from={{ opacity: 0, y: 18 }}
